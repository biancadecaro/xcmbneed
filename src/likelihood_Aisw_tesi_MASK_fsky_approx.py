...
cov_matrix = np.loadtxt('/ehome/bdecaro/xcmbneed/src/output_needlet_TG/Planck/Mask_noise/TG_512_lmax782_nuova_mask_tesi/cov_TS_galT_jmax12_B = 1.74 $_nside512_mask.dat')[1:(jmax),1:(jmax)]
...
beta_theory= np.loadtxt('/ehome/bdecaro/xcmbneed/src/output_needlet_TG/Planck/Mask_noise/TG_512_tesi/beta_TS_galS_theoretical_fiducial_B1.7422102429630426.dat')[1:(jmax)]
