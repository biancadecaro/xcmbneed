...
sims_dir        = 'sims/Needlet/Planck/TGsims_'+str(simparams['nside'])+'/'
out_dir         = 'output_needlet_TG/Planck/TG_'+str(simparams['nside'])+'/'
path_inpainting = 'inpainting/inpainting.py'
cov_dir 		= 'covariance/Planck/covariance_TG'+str(simparams['nside'])+'/'
