...
cov_matrix = np.loadtxt('/ehome/bdecaro/xcmbneed/src/output_needlet_TG/EUCLID/Mask_noise/TG_128_nsim1000_nuova_mask/cov_TS_galT_jmax12_B_1.59_nside128_fsky0.36.dat')[1:(jmax+1),1:(jmax+1)]

variance_theory = np.loadtxt('/ehome/bdecaro/xcmbneed/src/output_needlet_TG/EUCLID/Mask_noise/TG_128_nsim1000_nuova_mask/variance_gammaj_theory_B1.59_jmax12_nside128_lmax256_nsim1000_fsky0.36.dat')[1:(jmax+1)]
print(f'shape cov = {cov_matrix.shape}')
nj=cov_matrix.shape[1]

beta_fid_array = np.loadtxt('/ehome/bdecaro/xcmbneed/src/output_needlet_TG/EUCLID/Mask_noise/TG_128_nsim1000_nuova_mask/betaj_sims_TS_galT_jmax12_B_1.59_nside128_fsky0.36.dat')[:,1:(jmax+1)]
nsim = beta_fid_array.shape[0]

gamma_theory = np.loadtxt('/ehome/bdecaro/xcmbneed/src/output_needlet_TG/EUCLID/Mask_noise/TG_128_nsim1000_nuova_mask/gammaj_theory_B1.59_jmax12_nside128_lmax256_nsim1000_fsky0.36.dat')[1:(jmax+1)]


fsky=0.3563690185546875
...
plt.legend(loc = 'best')
plt.savefig(f'plot_tesi/Parameter_estimation/chi_squared_Aisw_{len(Aisw)}_EUCLID.png')
...
plt.legend(loc='best')
plt.tight_layout()
plt.savefig('plot_tesi/Parameter_estimation/Likelihood_Aisw_EUCLID_sim_100grid.png')
plt.savefig('plot_tesi/Parameter_estimation/Likelihood_Aisw_EUCLID_sim_100grid.pdf')
