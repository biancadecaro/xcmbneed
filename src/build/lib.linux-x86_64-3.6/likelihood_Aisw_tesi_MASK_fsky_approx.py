...
cov_matrix = np.loadtxt('/ehome/bdecaro/xcmbneed/src/output_needlet_TG/Planck/Mask_noise/TG_512_lmax782_nuova_mask_tesi/cov_TS_galT_jmax12_B = 1.74 $_nside512_mask.dat')[1:(jmax+1),1:(jmax+1)]
...
beta_fid_array = np.loadtxt('/ehome/bdecaro/xcmbneed/src/output_needlet_TG/Planck/Mask_noise/TG_512_lmax782_nuova_mask_tesi/betaj_sims_TS_galT_jmax12_B_1.7422102429630426_nside512_fsky_0.7800906499226888.dat')[:,1:(jmax+1)]
#beta_fid_array = np.loadtxt('/ehome/bdecaro/xcmbneed/src/output_needlet_TG/Planck/Mask_noise/TG_512_lmax782_nuova_mask_tesi/betaj_sims_TS_galT_jmax12_B_1.7422102429630426_nside512_fsky_0.7800906499226888.dat')[:,1:(jmax)]

#beta_fid_array_NO_fsky = np.loadtxt('/ehome/bdecaro/xcmbneed/src/output_needlet_TG/Planck/Mask_noise/TG_512_tesi_NO_fsky_approx/betaj_sims_TS_galT_jmax12_B_1.7422102429630426_nside512_fsky_0.7794118722279867.dat')[:,1:(jmax+1)]

#print(beta_fid_array_NO_fsky/beta_fid_array)

nsim = beta_fid_array.shape[0]

fsky=0.7800906499226888

beta_theory= np.loadtxt('/ehome/bdecaro/xcmbneed/src/output_needlet_TG/Planck/Mask_noise/TG_512_lmax782_nuova_mask_tesi/beta_TS_galS_theoretical_fiducial_B1.7422102429630426.dat')[1:(jmax+1)]
...
plt.legend(loc = 'best')
plt.savefig(f'plot_tesi/Parameter_estimation/chi_squared_Aisw_{len(Aisw)}_MASK_sky_approx.png')


index, = np.where(chi_squared == chi_squared.min())

filename = 'Posterior_Aisw_best-fit_MASK_fsky_approx'
...
plt.legend(loc='best')
plt.tight_layout()
plt.savefig('plot_tesi/Parameter_estimation/' +filename +'_100grid_like_definitivo.png')
#plt.savefig('plot_tesi/Parameter_estimation/' +filename +'_definitivo.pdf')
...
plt.legend(loc='best')
plt.tight_layout()
plt.savefig('plot_tesi/Parameter_estimation/Likelihood_Aisw_MASK_fsky_approx_sim_100grid_definitivo.png')
plt.savefig('plot_tesi/Parameter_estimation/Likelihood_Aisw_MASK_fsky_approx_sim_100grid_definitivo.pdf')
...
print('{0:0.2f}'.format(Aisw_mean/Aisw_std))


percentile_sim = np.percentile(Aisw_min, q = [16,50,84])
print(percentile_sim)

filename = 'Posterior_Aisw_best-fit_from_sims_MASK_fsky_approx'
...
plt.legend(loc='best')
plt.tight_layout()
plt.savefig('plot_tesi/Parameter_estimation/' +filename +'_definitivo.png')
plt.savefig('plot_tesi/Parameter_estimation/' +filename +'_definitivo.pdf')
