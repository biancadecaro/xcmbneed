...
beta_oml = np.array([np.loadtxt('output_needlet_TG_OmL/Grid_spectra_60/TGsims_512_OmL'+str(oml)+'/betaj_sims_TS_galS_Om'+str(oml)+'_jmax12_B = 1.74 _nside512.dat') for oml in OmL])
...
filename = 'Posterior_OmL_'+str(len(OmL))+'_sim'+str(num_sim)

percentile = liklh.Plot_posterior(posterior_distr, OmL, filename)
