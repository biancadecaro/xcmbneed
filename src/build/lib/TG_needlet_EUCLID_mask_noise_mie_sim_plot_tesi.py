...
out_dir         = f'output_needlet_TG/EUCLID/Mask_noise/prove/TG_{nside}_nsim{nsim}_mie_sims/'
...
simulations.Run(nsim, WantTG = True, EuclidSims=False)
...
fname_betaj_sims_TS_galS      = f'betaj_sims_TS_galS_jmax{jmax}_B_{myanalysis.B:0.2f}_nside{nside}.dat'
fname_betaj_sims_TS_galS_mask = f'betaj_sims_TS_galS_jmax{jmax}_B_{myanalysis.B:0.2f}_nside{nside}_fsky{fsky:0.2f}.dat'
...
betaj_sims_TS_galS       = myanalysis.GetBetajSimsFromMaps('TS', nsim, field2='galS', fname=fname_betaj_sims_TS_galS, fsky_approx=False,EuclidSims=False)
betaj_sims_TS_galS_mask  = myanalysis.GetBetajSimsFromMaps('TS', nsim, field2='galS', mask=mask, fname=fname_betaj_sims_TS_galS_mask, fsky_approx=False,EuclidSims=False)


betaj_sims_TS_galT       = myanalysis.GetBetajSimsFromMaps('TS', nsim, field2='galT', fname=fname_betaj_sims_TS_galT, fsky_approx=False,EuclidSims=False)
betaj_sims_TS_galT_mask  = myanalysis.GetBetajSimsFromMaps('TS', nsim, field2='galT', mask=mask, fname=fname_betaj_sims_TS_galT_mask, fsky_approx=False,EuclidSims=False)

# Covariances
print("...computing Cov Matrices...")
fname_cov_TS_galS            = f'cov_TS_galS_jmax{jmax}_B_{myanalysis.B:0.2f}_nside{nside}.dat'
fname_cov_TS_galS_mask       = f'cov_TS_galS_jmax{jmax}_B_{myanalysis.B:0.2f}_nside{nside}_fsky{fsky:0.2f}.dat'
...
cov_TS_galS, corr_TS_galS               = myanalysis.GetCovMatrixFromMaps(field1='TS', nsim=nsim, field2='galS', fname=fname_cov_TS_galT, fname_sims=fname_betaj_sims_TS_galS)
cov_TS_galS_mask, corr_TS_galS_mask     = myanalysis.GetCovMatrixFromMaps(field1='TS', nsim=nsim, field2='galS', mask=mask,fname=fname_cov_TS_galT_mask, fname_sims=fname_betaj_sims_TS_galS_mask)
...
betaj_TS_galS_mask_mean    = myanalysis.GetBetajMeanFromMaps('TS', nsim, field2='galS', mask=mask, fname_sims=fname_betaj_sims_TS_galS_mask)
...
delta_gammaj_noise = need_theory.variance_gammaj(cltg=cl_theory_tg,cltt=cl_theory_tt, clgg=cl_theory_gg, wl=wl, jmax=jmax, lmax=lmax, noise_gal_l=Nll)
delta_gammaj = need_theory.variance_gammaj(cltg=cl_theory_tg,cltt=cl_theory_tt, clgg=cl_theory_gg, wl=wl, jmax=jmax, lmax=lmax, noise_gal_l=None)

print(' diff variance theory noise:', 100*(delta_gammaj/delta_gammaj_noise-1))
...
np.savetxt(out_dir+f'variance_gammaj_theory_B{myanalysis.B:1.2f}_jmax{jmax}_nside{nside}_lmax{lmax}_nsim{nsim}_fsky{fsky:1.2f}.dat', delta_gammaj_noise)

#######################################################################################################
##RELATIVE DIFFERENCE MASK
...
ax.errorbar(myanalysis.jvec[1:jmax+1], (betaj_TS_galT_mask_mean[1:jmax+1] /gammaJ_tg[1:jmax+1]-1), yerr=np.sqrt(np.diag(delta_gammaj_noise)[1:jmax+1])/(np.sqrt(nsim)*gammaJ_tg[1:jmax+1]),  fmt='o', ms=5, label=r'Error of the mean of the simulations')
...
fig.tight_layout()
plt.savefig(out_dir+f'mask_gammaj_mean_T_gal_noise_jmax{jmax}_D{myanalysis.B:0.2f}_nsim{nsim}_nside{nside}_mask.png', bbox_inches='tight')
...
ax.errorbar(myanalysis.jvec[1:jmax+1], (betaj_TS_galS_mask_mean[1:jmax+1] /gammaJ_tg[1:jmax+1]-1), yerr=np.sqrt(np.diag(delta_gammaj)[1:jmax+1])/(np.sqrt(nsim)*gammaJ_tg[1:jmax+1]),  fmt='o', ms=5, label=r'Error of the mean of the simulations')
ax.errorbar(myanalysis.jvec[1:jmax+1], (betaj_TS_galS_mask_mean[1:jmax+1] /gammaJ_tg[1:jmax+1]-1), yerr=np.sqrt(np.diag(cov_TS_galS_mask)[1:jmax+1])/(np.sqrt(nsim)*gammaJ_tg[1:jmax+1]),  fmt='o', ms=5, label=r'Error of simulations')


ax.errorbar(myanalysis.jvec[1:jmax+1], (betaj_TS_galT_mask_mean[1:jmax+1] /gammaJ_tg[1:jmax+1]-1), yerr=np.sqrt(np.diag(delta_gammaj_noise)[1:jmax+1])/(np.sqrt(nsim)*gammaJ_tg[1:jmax+1]),  fmt='o', ms=5, label=r'NOISE Error of the mean of the simulations')
ax.errorbar(myanalysis.jvec[1:jmax+1], (betaj_TS_galT_mask_mean[1:jmax+1] /gammaJ_tg[1:jmax+1]-1), yerr=np.sqrt(np.diag(cov_TS_galT_mask)[1:jmax+1])/(np.sqrt(nsim)*gammaJ_tg[1:jmax+1]),  fmt='o', ms=5, label=r'NOISE Error of simulations')
...
fig.tight_layout()
plt.savefig(out_dir+f'noise_gammaj_mean_T_gal_noise_jmax{jmax}_D{myanalysis.B:0.2f}_nsim{nsim}_nside{nside}_mask.png', bbox_inches='tight')
#plt.savefig(f'plot_tesi/Euclid/gammaj_mean_T_gal_noise_jmax{jmax}_D{myanalysis.B:0.2f}_nsim{nsim}_nside{nside}_mask.png', bbox_inches='tight')
#plt.savefig(f'plot_tesi/Euclid/gammaj_mean_T_gal_noise_jmax{jmax}_D{myanalysis.B:0.2f}_nsim{nsim}_nside{nside}_mask.pdf', bbox_inches='tight')
...
diff_cov_mask = np.abs((np.sqrt(np.diag(cov_TS_galT_mask))-np.sqrt(np.diag(delta_gammaj_noise))))/np.sqrt(np.diag(delta_gammaj_noise))*100
...
#ax.plot(myanalysis.jvec[1:jmax+1], gammaJ_tg[1:jmax+1], label='Theory')
ax.plot(myanalysis.jvec, (np.sqrt(np.diag(cov_TS_galT_mask))-np.sqrt(np.diag(delta_gammaj_noise)))/np.sqrt(np.diag(delta_gammaj_noise))*100 ,color='#2b7bbc', label='MASK')
ax.plot(myanalysis.jvec, (np.sqrt(np.diag(cov_TS_galT))-delta_noise)/delta_noise*100 , label='FULL SKY')
ax.plot(myanalysis.jvec, (np.sqrt(np.diag(cov_TS_galS_mask))-np.sqrt(np.diag(delta_gammaj)))/np.sqrt(np.diag(delta_gammaj))*100 , label='Signal only')
...
s2n_mean_sim=S_2_N_th(betaj_TS_galT_mask_mean[1:jmax+1], np.diag(delta_gammaj_noise)[1:jmax+1])
