...
out_dir         = f'output_needlet_TG/EUCLID/Mask_noise/TG_{nside}_nsim{nsim}_Planck_mask/'
...
def cov_pseudo_cl(cltg,cltt, clgg, wl, lmax, noise_gal_l=None):
    ...
    return covll
cls_tg = np.loadtxt('/ehome/bdecaro/xcmbneed/src/cls_from_maps/EUCLID/Planck mask/cls_Tgalnoise_anafast_nside128_lmax256_Euclidnoise_Marina_nsim1000_fsky0.78.dat')
