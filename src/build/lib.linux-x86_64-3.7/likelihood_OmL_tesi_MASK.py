...
plt.legend(loc = 'best')
plt.savefig(f'plot_tesi/Parameter_estimation/chi_squared_mean_{len(OmL)}_theoretical_OmL_MASK.png')

filename = f'Posterior_OmL_{len(OmL)}_mean_sim_best-fit_theoretical_OmL_MASK'
...
plt.legend(loc='best')
plt.tight_layout()
filename = f'Posterior_OmL_{len(OmL)}_mean_sim_best-fit_theoretical_OmL_from_sims_MASKS'
plt.savefig('plot_tesi/Parameter_estimation/' +filename +'.png')
plt.savefig('plot_tesi/Parameter_estimation/' +filename +'.pdf')
