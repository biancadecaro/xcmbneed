...
setup(name="cython_mylibc",
      ...
      ext_modules=[Extension("cython_mylibc", sources,
                             include_dirs=[nm.get_include(), "../include", HOME+"/fftw3/fftw-3.3.10-double/include", HOME+"/gsl/gsl-2.7.1/include"],
                             libraries=["mylibc","gsl","gslcblas","fftw3_omp","fftw3"],
                             library_dirs=["../", GCCPATH.decode("utf-8"), HOME+"/fftw3/fftw-3.3.10-double/lib", HOME+"/gsl/gsl-2.7.1/lib"],
