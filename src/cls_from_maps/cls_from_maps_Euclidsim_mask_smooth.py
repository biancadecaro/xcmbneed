...
mask = hp.read_map(f'/ehome/bdecaro/xcmbneed/src/mask/EUCLID/mask_ESWG_basic_ns128.fits')
fsky = np.mean(mask)
for n in range(nsim):
...
filename_TT = f'EUCLID/Euclid mask smooth/cls_TT_anafast_nside{nside}_lmax{lmax}_Euclidnoise_Marina_nsim{nsim}.dat'#lmin{lmin}_marina.dat'
filename_GG = f'EUCLID/Euclid mask smooth/cls_galnoisegalnoise_anafast_nside{nside}_lmax{lmax}_Euclidnoise_Marina_nsim{nsim}.dat'#lmin{lmin}_marina.dat'

filename_TT_mask = f'EUCLID/Euclid mask smooth/cls_TT_anafast_nside{nside}_lmax{lmax}_Euclidnoise_Marina_nsim{nsim}_fsky{fsky:0.2f}.dat'#lmin{lmin}_marina.dat'
filename_GG_mask = f'EUCLID/Euclid mask smooth/cls_galnoisegalnoise_anafast_nside{nside}_lmax{lmax}_Euclidnoise_Marina_nsim{nsim}_fsky{fsky:0.2f}.dat'#lmin{lmin}_marina.dat'

filename_TG = f'EUCLID/Euclid mask smooth/cls_Tgalnoise_anafast_nside{nside}_lmax{lmax}_Euclidnoise_Marina_nsim{nsim}.dat'#lmin{lmin}_marina.dat'
filename_TG_mask = f'EUCLID/Euclid mask smooth/cls_Tgalnoise_anafast_nside{nside}_lmax{lmax}_Euclidnoise_Marina_nsim{nsim}_fsky{fsky:0.2f}.dat'#lmin{lmin}_marina.dat'
...
filename_map_GG = f'EUCLID/Euclid mask smooth/cls_galgalnoise_map_nside{nside}_lmax{lmax}_Euclidnoise_Marina_nsim{nsim}.fits'
filename_map_GG_mask = f'EUCLID/Euclid mask smooth/cls_galgalnoise_map_nside{nside}_lmax{lmax}_Euclidnoise_Marina_nsim{nsim}_fsky{fsky:0.2f}.fits'
