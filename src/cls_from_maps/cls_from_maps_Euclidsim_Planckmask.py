...
filename_TT = f'EUCLID/Planck mask/cls_TT_anafast_nside{nside}_lmax{lmax}_Euclidnoise_Marina_nsim{nsim}.dat'#lmin{lmin}_marina.dat'
filename_GG = f'EUCLID/Planck mask/cls_galnoisegalnoise_anafast_nside{nside}_lmax{lmax}_Euclidnoise_Marina_nsim{nsim}.dat'#lmin{lmin}_marina.dat'

filename_TT_mask = f'EUCLID/Planck mask/cls_TT_anafast_nside{nside}_lmax{lmax}_Euclidnoise_Marina_nsim{nsim}_fsky{fsky:0.2f}.dat'#lmin{lmin}_marina.dat'
filename_GG_mask = f'EUCLID/Planck mask/cls_galnoisegalnoise_anafast_nside{nside}_lmax{lmax}_Euclidnoise_Marina_nsim{nsim}_fsky{fsky:0.2f}.dat'#lmin{lmin}_marina.dat'

filename_TG = f'EUCLID/Planck mask/cls_Tgalnoise_anafast_nside{nside}_lmax{lmax}_Euclidnoise_Marina_nsim{nsim}.dat'#lmin{lmin}_marina.dat'
filename_TG_mask = f'EUCLID/Planck mask/cls_Tgalnoise_anafast_nside{nside}_lmax{lmax}_Euclidnoise_Marina_nsim{nsim}_fsky{fsky:0.2f}.dat'#lmin{lmin}_marina.dat'
...
filename_map_GG = f'EUCLID/Planck mask/cls_galgalnoise_map_nside{nside}_lmax{lmax}_Euclidnoise_Marina_nsim{nsim}.fits'
filename_map_GG_mask = f'EUCLID/Planck mask/cls_galgalnoise_map_nside{nside}_lmax{lmax}_Euclidnoise_Marina_nsim{nsim}_fsky{fsky:0.2f}.fits'
