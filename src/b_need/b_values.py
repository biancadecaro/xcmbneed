...
print(b_need_1p7.shape) #dovrebbe essere j righe e l colonne
...
print(b_need_1p83.shape) #dovrebbe essere j righe e l colonne
...
print(b_need_1p95.shape) #dovrebbe essere j righe e l colonne
